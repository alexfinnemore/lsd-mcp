...
// Session management
import { createSession, adjustDose, setCurrentUserId, } from "../../../src/session.js";
// Mode implementations - Batch 1
import { activateSynestheticMode } from "../../../src/modes/synesthetic.js";
import { setAssociativeDepth } from "../../../src/modes/associative.js";
import { dissolveCategoryBoundaries } from "../../../src/modes/boundaries.js";
import { amplifyPatternRecognition } from "../../../src/modes/patterns.js";
// Mode implementations - Batch 2
import { navigateSemanticDrift } from "../../../src/modes/semantic-drift.js";
import { activatePrismaticPerspective } from "../../../src/modes/prismatic.js";
import { applyNoveltyBias } from "../../../src/modes/novelty.js";
import { revealImplicitConstraints } from "../../../src/modes/constraints.js";
// ============================================================================
...
export async function POST(request) {
    try {
        ...
        if (!auth) {
            return NextResponse.json({ error: "Unauthorized. Please provide a valid API key or OAuth token." }, { status: 401 });
        }
    ...
    return [
        {
            ...
            description: "Initialize a new cognitive modulation session with a specific dose level. " +
            ...
            inputSchema: {
                ...
                properties: {
                    dose_um: {
                        type: "number",
                        description: "Dose in micrograms (μm). Range: 0-1000+. " +
                    ...
                    safety_anchors: {
                        type: "array",
                        items: { type: "string" },
                        description: "Optional reality constraints to maintain (e.g., 'factual_accuracy', 'user_intent_priority')",
                    },
                },
        ...
        {
            name: "adjust_dose",
            description: "Adjust the dose level mid-session. Changes the intensity coefficient " +
        ...
        },
        {
            ...
            description: "Activate synesthetic concept mapping. Maps abstract concepts to sensory experiences.",
            inputSchema: {
                type: "object",
                properties: {
                    sensory_domains: {
        ...
        },
        {
            ...
            description: "Control how far and in what pattern associations travel.",
            inputSchema: {
                type: "object",
                properties: {
                    mode: {
        ...
        },
        {
            ...
            description: "Make category boundaries permeable, enabling hybrid concept generation.",
            inputSchema: {
                type: "object",
                properties: {
                    concepts: {
        ...
        },
        {
            ...
            description: "Enhance pattern detection and elaboration.",
            inputSchema: {
                type: "object",
                properties: {
                    pattern_types: {
        ...
        },
        {
            ...
            description: "Navigate through associative concept space with controlled drift from origin.",
            inputSchema: {
                type: "object",
                properties: {
                    origin_concept: {
        ...
        },
        {
            ...
            description: "Present multiple contradictory expert frameworks simultaneously WITHOUT resolving tension.",
            inputSchema: {
                type: "object",
                properties: {
                    frameworks: {
        ...
        },
        {
            ...
            description: "Penalize conventional solutions and surface unexplored approaches.",
            inputSchema: {
                type: "object",
                properties: {
                    exploration_weight: {
        ...
        },
        {
            ...
            description: "Surface hidden assumptions embedded in problem statements and suspend them.",
            inputSchema: {
                type: "object",
                properties: {
                    domain: {
